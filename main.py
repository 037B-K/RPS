...
class MyGame(arcade.Window):
   ...
   """
    ...
    def validate_victory(self):
        # Else ici means AttackType.PAPER
    ...
    def draw_scores(self):
        # Player score
        arcade.draw_text('Le pointage du joueur est '+str(self.player_score), self.player.center_x - self.ATTACK_FRAME_WIDTH - 50,
                         165 - self.ATTACK_FRAME_HEIGHT, arcade.color.CYAN, 12, int(self.ATTACK_FRAME_WIDTH * 3),
                         align="center")
        # Computer score
        arcade.draw_text("Le pointage de l'ordinateur est "+str(self.computer_score), self.computer.center_x - self.ATTACK_FRAME_WIDTH - 50,
    ...
    def draw_instructions(self):
        ...
        if self.game_state == GameState.GAME_OVER:
            arcade.draw_text('Appuyez sur "Space" pour recommencer la partie!', 360, 440)
        else:
            pass
